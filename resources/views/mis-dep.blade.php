                            ...
                            <div class="row clearfix">
                                <table class="table" style="border: 1px #3a9e1e">
								  ...
								  <tbody>
									...
									<tr>
									  <th scope="row">2</th>
									  <td style="text-align: left;">Mr. Sajid Rafiq</td>
									  <td>Deputy Manager MIS</td>
									</tr>
									<tr>
									  <th scope="row">3</th>
									  <td style="text-align: left;">Mr. Azhar Javaid</td>
									  <td>Deputy Manager MIS</td>
									</tr>
									<tr>
									  <th scope="row">4</th>
									  <td style="text-align: left;">Mr. Waqar-ul-Hassan</td>
