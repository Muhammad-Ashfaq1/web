...
<header class="main-header">
                ...
                <div class="top-inner">
                    <div class="top-left">
                        <ul class="info-list clearfix">
                            <li><i class="icon-2"></i>Email: <a href="mailto:info@lwmc.com.pk">info@lwmc.com.pk</a></li>
                            <li><i class="icon-3"></i>Address: <span>4th Floor Shaheen Complex, Egerton Road Lahore</span></li>
                        </ul>
                    </div>
                    <div class="top-right">
                        <ul class="social-links clearfix">
                            <li><a href="https://www.facebook.com/LWMC1139/"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="https://x.com/SPAL_1139"><i class="fab fa-twitter"></i></a></li>
                            <li><a href="https://www.linkedin.com/company/lahore-waste-managment-co/posts/?feedView=all"><i class="fab fa-linkedin-in"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="header-lower">
        <div class="outer-box">
            <div class="logo-box">
                <figure class="logo"><a href=""><img src="/images/logo1.png" alt=""></a></figure>
            </div>
            <div class="menu-area">
                        ...
                        <ul class="navigation clearfix">
                            ...
                            <li class="dropdown {{ Request::is('About-Suthra-Punjab*') || Request::is('company-profile*') || Request::is('register-volunteer*') || Request::is('membership*') || Request::is('*-Department*') || Request::is('Board-of-Directors*') || Request::is('LWMC-Organogram*') || Request::is('Right-to-Information*') || Request::is('WMC-PMU-Summary*') ? 'current' : '' }}"><a href="">About LWMC</a>
                                <ul>
                                    ...
                                    <li><a href="LWMC-Organogram">Organogram</a></li>
                                    <li><a href="Right-to-Information">Right to Information</a></li>
                                    <li><a href="WMC-PMU-Summary">WMC's PMU Summary</a></li>
                            ...
                            <li class="dropdown {{ Request::is('Gallery*') || Request::is('Video-Gallery*') || Request::is('brochures*') ? 'current' : '' }}"><a href="">Media Gallery</a>
                                <ul>
                                    ...
                                    <li><a href="">LWMC News Clippings</a></li>
                            ...
                            <li class="dropdown {{ Request::is('plans*') || Request::is('projects*') ? 'current' : '' }}"><a href="">Our Plans</a>
                                <ul>
                                    ...
                                    <li><a href="">Eid Plan</a></li>
                                    <li><a href="">Operation Plan</a></li>
...
<div class="mobile-menu">
    ...
    <nav class="menu-box">
        ...
        <div class="contact-info">
            <h4>Contact Info</h4>
            <ul>
                <li>4th Floor Shaheen Complex Egerton Road, Lahore</li>
                <li><a href="tel:+924299205153">+92 42 99205153-55</a></li>
                <li><a href="mailto:info@lwmc.com.pk">info@lwmc.com.pk</a></li>
            </ul>
        </div>
        <div class="social-links">
            <ul class="clearfix">
                <li><a href=""><span class="fab fa-twitter"></span></a></li>
                <li><a href="https://www.facebook.com/LWMC1139/"><span class="fab fa-facebook-square"></span></a></li>
                <li><a href="https://www.instagram.com/lwmc1139/?hl=en"><span class="fab fa-instagram"></span></a></li>
            </ul>
        </div>
    </nav>
</div>
